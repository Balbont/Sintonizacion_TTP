...
vector<vector<vector<int>>> tabu_search_epl_reducido(int distancia_optima, int fecha_boxing_day, int fecha_new_year, vector<vector<int>> rueda1, vector<vector<int>> rueda2, vector<int> equipos_fuertes, vector<int> equipos_UCL, vector<int> equipos_UEL,
                ...
                //for(int j = i+1; j<= cantidad_equipos; j++){ //t1
                    //for (int k = 1; k <= cantidad_fechas; k++){ //fecha
                        //for(int rueda_elegida = 1; rueda_elegida <= 2; rueda_elegida++){ // rueda
                            ...
                            int i = distrib_equipo(gen);
                            int j = distrib_equipo(gen);
                            while (i == j)
                            {
                                j = distrib_equipo(gen);
                            }
                            int k = distrib_fecha(gen);
...
vector<vector<vector<int>>> sa_epl(int distancia_optima, int fecha_boxing_day, int fecha_new_year, vector<vector<int>> rueda1, vector<vector<int>> rueda2, vector<int> equipos_fuertes, vector<int> equipos_UCL, vector<int> equipos_UEL,
    ...
    for (int iteracion=0; iteracion < cantidad_iteraciones; iteracion++){
        ...
        //cout << "Iteracion: " << iteracion << " Temperatura: " << temperatura << " Evaluacion actual: " << mejor_evaluacion_actual << " Mejor evalucion: " << mejor_evaluacion_global << endl;
